...
//    private static final Map<Identifier, DynamicTexture> DYNAMIC_TEXTURE_CACHE = new HashMap<>();
//    private static final TextureManager TEXTURE_MANAGER = Minecraft.getInstance().getTextureManager();
//
//    public static void drawImg(GuiGraphicsExtractor guiGraphics, Identifier texturePath, int x, int y, int width, int height) {
//        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texturePath, x, y, 0, 0, width, height, width, height);
//    }
//
//    public static void drawWithZ(GuiGraphics guiGraphics, Identifier texturePath, int x, int y, int z, int width, int height) {
...
//    }
//
//    public static void renderRect(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height, int lineWidth, int lineColor, int fillColor) {
...
//         */
//        public void drawTo(GuiGraphics guiGraphics, Identifier texturePath,
//                           int x, int y, int width, int height) {
//            try {
//                String cacheId = cacheKey != null ? cacheKey : generateCacheKey(texturePath);
//
//                if (cacheResult && DYNAMIC_TEXTURE_CACHE.containsKey(Identifier.parse(cacheId))) {
//                    drawImg(guiGraphics, Identifier.parse(cacheId), x, y, width, height);
//                    return;
//                }
//
...
//                original.close();
//
//                Identifier dynamicTexture = createOrUpdateDynamicTexture(Identifier.parse(cacheId), result);
...
//
//                if (cacheResult && DYNAMIC_TEXTURE_CACHE.containsKey(Identifier.parse(cacheId))) {
//                    drawBlending(guiGraphics, Identifier.parse(cacheId), x, y, width, height, blendMode);
//                    return;
//                }
//
//                NativeImage original = loadImage(texturePath);
...
//        }
//
//        private String generateCacheKey(Identifier base) {
...
//    }
//
//    private static NativeImage loadImage(Identifier texturePath) throws IOException {
...
//    }
//
//    private static NativeImage loadAndManipulateImage(Identifier texturePath, PixelManipulator manipulator) throws IOException {
//        NativeImage original = loadImage(texturePath);
...
//                manipulated.setPixel(x, y, manipulatedColor);
//            }
//        }
//
//        original.close();
...
//    }
//
//    private static Identifier createOrUpdateDynamicTexture(Identifier basePath, NativeImage image) {
//        String dynamicPath = basePath.toString() + "_dynamic";
//        Identifier dynamicLocation = Identifier.parse(dynamicPath);
//
...
//     */
//    public static void drawBlending(GuiGraphics guiGraphics, Identifier texturePath,
//                                         int x, int y, int width, int height, BlendMode blendMode) {
