...
public final class TextUtils {
     ...
     */
    public static int drawWrappedText(GuiGraphicsExtractor guiGraphics, Component component, int x, int y, int maxWidth, int color, boolean dropShadow) {
     ...
     * @return The total height of the rendered text
     */
    public static int drawWrappedText(GuiGraphicsExtractor guiGraphics, Component component, int x, int y, int maxWidth, int lineSpacing, int color, boolean dropShadow) {
        Font font = Minecraft.getInstance().font;
        List<FormattedCharSequence> lines = font.split(component, maxWidth);
