...
//    }
//
//    private void renderRecipe(GuiGraphicsExtractor guiGraphics, double guiScaleFactor) {
//        Matrix3x2fStack mx = guiGraphics.pose();
//        try {
//            guiGraphics.fill(
//                    this.getX(),
//                    this.getY(),
...
//
//            mx.translate(
//                    (float) (this.getX() + (this.getWidth() / 2.0)),
...
//            mx.scale(previewScale, -previewScale);
//
...
//    }
//
////    private void drawBlocks(Matrix3x2fStack mx, MultiBufferSource.BufferSource buffers) {
////        mx.rotate(new Quaternionf().rotationXYZ(
...
//            if (isHovered()) {
//                rotation = (rotation + dy) % 360;
//                yOffset = (yOffset - dx) % 360;
//                return true;
//            }
//        }
//
...
//
//        if (isHovered()) {
//            guiGraphics.outline(this.getX(), this.getY(), this.getWidth(), this.getHeight(), 0x80FFFFFF);
//        }
//    }
//
//    @Override
