//package com.portingdeadmods.portingdeadlibs.api.gui.utils;
//
...
//    private FluidHandlerWrapper fluidHandlerWrapper;
//
//    enum TooltipMode {
//        SHOW_AMOUNT,
...
//    }
//
//    public FluidTankRenderer(FluidHandlerWrapper fluidHandlerWrapper, boolean showCapacity, int width, int height) {
//        this(fluidHandlerWrapper, showCapacity ? TooltipMode.SHOW_AMOUNT_AND_CAPACITY : TooltipMode.SHOW_AMOUNT, width, height);
//    }
//
//    private FluidTankRenderer(FluidHandlerWrapper fluidHandlerWrapper, TooltipMode tooltipMode, int width, int height) {
//        Preconditions.checkArgument(fluidHandlerWrapper.getFluidCapacity() > 0, "capacity must be > 0");
//        Preconditions.checkArgument(width > 0, "width must be > 0");
//        Preconditions.checkArgument(height > 0, "height must be > 0");
//
//        this.fluidHandlerWrapper = fluidHandlerWrapper;
...
//        long scaledAmount = (amount * height) / this.fluidHandlerWrapper.getFluidCapacity();
//
...
//    }
//
//    private void drawTiledSprite(GuiGraphicsExtractor guiGraphics, final int tiledWidth, final int tiledHeight, int color, long scaledAmount, TextureAtlasSprite sprite) {
//        guiGraphics.blitInscribed(RenderPipelines.GUI_TEXTURED, 0, 0, this.getWidth(), this.getHeight(), this.getWidth(), this.getHeight());
//    }
//
...
//            PortingDeadLibs.LOGGER.error("Failed to get tooltip for fluid: ", e);
//        }
//
//        return tooltip;
//    }
